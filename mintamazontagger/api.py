# TEMPORARY FORK TO RESOLVE ISSUE 67 RELATING TO WINERROR 6: THE HANDLE IS INVALID.
# LICENSE: MIT
# SOURCE: https://github.com/mrooney/mintapi/blob/a69e48ce02d976ff656f97e8409bf4f3a4d21df9/mintapi/api.py
...
def get_chrome_driver_major_version_from_executable(local_executable_path):
    ...
    # check_output can fail if running from a thread without a console on win10.
